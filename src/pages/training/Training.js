...
const description = "At Ey3, we've shifted from Federal Government contracting to impactful Workforce Development Training in Prince George's County, MD.";
        ...
        <ProjectSection>
          <ProjectSectionColumns centered className={styles.columns}>
            <div className={styles.imagesText}>
              <ProjectSectionHeading style={{textTransform: "uppercase"}}><DecoderText delay={0} text={"Empowering Communities"}/></ProjectSectionHeading>
              <ProjectSectionText>
                At Ey3 Technologies, our heart lies in community service, driving our transition from Federal Government contracting to Workforce Development Training in Prince George's County, MD. Within a year, we've trained over 40 individuals from diverse backgrounds, ages 18 to 63, in Scrum, with a 100% PSM 1 certification success rate. Our commitment extends beyond local impacts; we're recognized on the State of Maryland's Training Provider list and have expanded our courses to include Customer Service, FAA Part 107 Drone/UAS Certification, and CMMC Cybersecurity. Through partnerships with local organizations and law enforcement, we're dedicated to empowering every demographic with career opportunities, emphasizing reskilling and upskilling to uplift the entire community.<br/>
              </ProjectSectionText>
            </div>
          ...
          This initiative reflects our core values: serving and uplifting the community. In just one year, we've proudly trained over 40 individuals across various states in Scrum methodologies, achieving a remarkable 100% pass rate for the PSM 1 certification. Our participants' age range, spanning from 18 to 63 years, exemplifies our commitment to inclusivity and diversity in education.
          </ProjectSectionText>
        </ProjectSection>
        <ProjectSection light>
          <ProjectSectionContent>
            <ProjectTextRow>
              {<ProjectSectionHeading style={{ textTransform: "uppercase" }}><DecoderText delay={0} text={"Accomplishments"} /></ProjectSectionHeading>}
              <ProjectSectionText>
                Our efforts have not only earned us a place on the State of Maryland's Training Provider list but also enabled us to enrich Prince George's County through our partnership with Employ Prince George's. We've expanded our training portfolio to include Customer Service, FAA Part 107 Drone/UAS Certification, and CMMC (Cybersecurity). These additions underscore our dedication to providing comprehensive, cutting-edge training.              
              </ProjectSectionText>
            </ProjectTextRow>
            <Image
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent className={styles.grid}>
            ...
            <div className={styles.gridText}>
              <ProjectSectionHeading style={{ textTransform: "uppercase" }}><DecoderText delay={0} text={"Fostering Connections"} /></ProjectSectionHeading>
              <ProjectSectionText>
                Building bridges within the community, we've fostered new partnerships with local fraternities and the PG County Police Department. Our goal is clear: to open doors to potential career opportunities through reskilling and upskilling. We aim to touch every demographic - from the youth to seniors, career changers to returning citizens - ensuring everyone has access to the tools they need for success in the modern workforce.
                <br/>
                <br/>
                As we continue our journey of community engagement, the bridges we've built have paved the way for promising collaborations. With a steadfast commitment to our goal of creating diverse career opportunities through reskilling and upskilling initiatives, we aspire to impact individuals across all walks of life, spanning from the younger generation to seniors,career transitioners to returning citizens. Our ongoing efforts aim to ensure that every member of our community possesses the necessary tools for success in today's dynamic workforce landscape.
              </ProjectSectionText>
            </div>
          </ProjectSectionContent>
        </ProjectSection>
